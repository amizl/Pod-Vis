...
CREATE TABLE IF NOT EXISTS `cliovis`.`cohort` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_cohort_user1_idx` (`user_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cliovis`.`cohort_query` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_cohort_query_cohort1_idx` (`cohort_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cliovis`.`cohort_subject` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_cohort_subject_cohort1_idx` (`cohort_id` ASC) VISIBLE,
  INDEX `fk_cohort_subject_subject1_idx` (`subject_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cliovis`.`collection` (
  ...
  `instantiation_type` ENUM('static', 'dynamic') NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_collection_user1_idx` (`creator_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cliovis`.`collection_query` (
  ...
  `value` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_collection_query_collection1_idx` (`collection_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cliovis`.`collection_study` (
  ...
  INDEX `fk_collection_study_collection1_idx` (`collection_id` ASC) VISIBLE,
  INDEX `fk_collection_study_study1_idx` (`study_id` ASC) VISIBLE,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `cliovis`.`observation` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `subject_visit_id_UNIQUE` (`subject_visit_id` ASC, `item` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cliovis`.`project` (
  ...
  INDEX `fk_project_user_idx` (`owner_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cliovis`.`study` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `study_name_UNIQUE` (`study_name` ASC) VISIBLE,
  INDEX `fk_study_project1_idx` (`project_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cliovis`.`subject` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `subject_num_UNIQUE` (`subject_num` ASC, `study_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cliovis`.`subject_attribute` (
  ...
  `value` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_subject_attribute_subject1_idx` (`subject_id` ASC) VISIBLE,
  INDEX `fk_subject_attribute_subject_ontology1_idx` (`subject_ontology_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cliovis`.`subject_ontology` (
  ...
  `parent_id` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_subject_ontology_subject_ontology1_idx` (`parent_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cliovis`.`subject_visit` (
  ...
  `subject_id` INT(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `visit_num_UNIQUE` (`visit_num` ASC, `subject_id` ASC) VISIBLE,
  INDEX `fk_subject_visit_subject1_idx` (`subject_id` ASC) VISIBLE,
