...
CREATE TABLE IF NOT EXISTS `cliovis`.`collection` (
  ...
  `label` VARCHAR(255) NOT NULL,
  `date_generated` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
  `is_public` TINYINT(1) NOT NULL DEFAULT 0,
  `instantiation_type` ENUM('static', 'dynamic') NOT NULL,
  `last_modified` TIMESTAMP(2) GENERATED ALWAYS AS (CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP),
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `cliovis`.`collection_observation_variable` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `collection_id` INT NOT NULL,
  `observation_scale` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`id`),
